...
namespace kutuphane_otomasyou.Controllers
{
    public class kitaplarimController : Controller
    {
        ...
        public ActionResult oduncAl(string Kitapismi)
        {
            ...
            if (Kitapismi != null)
            {
                ...
                var alinanKitaplar = new AlinanKitaplar
                {
                    ...
                    IadeTarihi = DateTime.Now.AddDays(21)
                };
        ...
        public ActionResult kitapDetaylari(string Kitapismi)
        {
            ...
            databaseContextcs db = new databaseContextcs();
            var kitap = db.kitaptablosu.FirstOrDefault(x => x.kitap_adi == Kitapismi);


            TempData["yazar"] = kitap.yazar;
            TempData["kitap_adi"] = kitap.kitap_adi;
            TempData["turu"] = kitap.turu;
        ...
        public ActionResult AlinanKitapDetaylari(string Kitapismi)
        {
            ...
            databaseContextcs db = new databaseContextcs();
            var kitap = db.AlinanKitapTaplosu.FirstOrDefault(x => x.kitap_adi == Kitapismi);
            ...
            TempData["sayfa_sayisi"] = kitap.sayfa_sayisi;
            TempData["yili"] = kitap.yili;
            TempData["IadeTarihi"] = kitap.IadeTarihi;
